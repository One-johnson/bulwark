...
const Basic3UpdateForm = () => {
  const { customID } = useParams();

  const navigate = useNavigate();
  useEffect(() => {
    axios
      .get("http://localhost:3002/basic3/view/" + customID)
      .then((res) => {
        console.log(res);
        setValues({
          ...values,
  ...
  const handleUpdate = (event) => {
    ...
    axios
      .put("http://localhost:3002/basic3/update/" + customID, values)
      .then((res) => {
        console.log(res);
...
export default Basic3UpdateForm;
