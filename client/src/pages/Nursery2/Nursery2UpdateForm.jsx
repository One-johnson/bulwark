...
const Nursery2UpdateForm = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3002/nursery2/view/" + customID)
      .then((res) => {
        console.log(res);
        setValues({
          ...values,
  ...
  const handleUpdate = (event) => {
    ...
    axios
      .put("http://localhost:3002/nursery2/update/" + customID, values)
      .then((res) => {
        console.log(res);
...
export default Nursery2UpdateForm;
