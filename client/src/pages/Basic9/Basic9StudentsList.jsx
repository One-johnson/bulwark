...
const Basic9StudentsList = () => {
  ...
  const tableHeadStyles =
    "border-r px-6 py-3 text-center text-xs font-medium text-gray-800 uppercase tracking-wider";
                ...
                <tr key={index}>
                  ...
                  <td className="px-6 py-4 text-md font-medium ">
                    <div className="flex flex-col-1 items-center">
                      <Link
                        to={`/basic9/view/${student.id}`}
                        className="text-blue-600 mr-2"
                      >
                        <FaRegEye />
                      </Link>
                      <Link
                        to={`/basic9/edit/${student.id}`}
