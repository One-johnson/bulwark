    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex flex-col-1 items-center">
          <Link to={`/kg1/view/${row.id}`} className="text-blue-600 mr-2">
            <FaRegEye />
          </Link>
          <Link to={`/kg1/edit/${row.id}`} className="text-green-600  mr-2">
            <FiEdit3 />
          </Link>
...
export default Kg1StudentsList;
